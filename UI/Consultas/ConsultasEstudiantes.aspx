<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultasEstudiantes.aspx.cs" Inherits="PrimerParcial.UI.Consultas.ConsultasEstudiantes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=15.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta Estudiante</div>
                ...
                <asp:GridView ID="DatosGridView"
                    ...
                    <Columns>
                        <asp:HyperLinkField ControlStyle-ForeColor="blue"
                            ...
                            DataNavigateUrlFormatString="~/UI/Registros/RegistrosEstudiantes.aspx?Id={0}"
                ...
                <div class="modal-dialog modal-sm" style="max-width: 600px!important; min-width: 300px!important">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <%--Viewer--%>
                           <%-- <rsweb:ReportViewer ID="MyEstudiantesReportViewer" runat="server" ProcessingMode="Remote" Height="400px" Width="500px">
