<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrosCategorias.aspx.cs" Inherits="PrimerParcial.UI.Registros.RegistrosCategorias" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="form-horizontal col-md-12" role="form">
                   ...
                   <%-- Promedio--%>
                    <div class="form-group">
                        <label for="Promedio:" class="col-md-3 control-label input-sm">Promedio: </label>
                        <div class="col-md-6">
                            <asp:TextBox class="form-control input-sm" TextMode="Number" ID="PromedioTextBox" Text="0" runat="server" Visible="true"></asp:TextBox>
                        </div>
                    </div>
